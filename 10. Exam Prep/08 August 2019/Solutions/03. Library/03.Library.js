class Library {
    ...
    unsubscribe(name){
        ...
        this.subscribers.splice(subscriberIndex, 1); // to remove it
    ...
    receiveBook(subscriberName, bookTitle, bookAuthor){
        ...
        const bookCount = this.subscriptionTypes[subType];

        if(foundSubscriber.books.length >= bookCount){
            throw new Error(`You have reached your subscription limit ${bookCount}!`)
        }
